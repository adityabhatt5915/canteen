        ...
        if (event.target.classList.contains('remove-item')){
            ...
            addItem.forEach(item => {
                if (item.FoodID === id){ 
                    ...
                    if ( window.location != 'C:\Users\ASUS\Downloads\mit-canteen-site-master\mit-canteen-site-master/user-orders.html'){
...
function ClientDataFlow(addToCartBtn){
    ...
    firebase.auth().onAuthStateChanged((user) => {
        if (user) {
            ...
            checkOutBtn.addEventListener('click', ()=>{
                ...
                if (addItem.length != 0){
                    ...
                    window.setTimeout(function(){
                        window.location.replace('C:\Users\ASUS\Downloads\mit-canteen-site-master\mit-canteen-site-master/user-orders.html')
                    }, 2600)
                } else {
                    Swal.fire({
                        icon: 'error',
            ...
            // Shows Orders
            if (window.location.href === "C:\Users\ASUS\Downloads\mit-canteen-site-master\mit-canteen-site-master/user-orders.html"){
