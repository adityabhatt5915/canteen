...
class signUpMethods {
  ...
  static authRedirecting() {
    window.setTimeout(() => {
      window.location.replace('C:/Users/ASUS/Downloads/mit-canteen-site-master/mit-canteen-site-master/client-side.html');
    }, 500);
  }
  ...
  firebaseAuthRedirect() {
    firebase.auth().onAuthStateChanged(function (user) {
      ...
      user ? window.location.replace('C:/Users/ASUS/Downloads/mit-canteen-site-master/mit-canteen-site-master/client-side.html') : console.log('none');
    });
  }
}
