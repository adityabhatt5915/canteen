    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-green">CANTEEN</span> </h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-green md">CANTEEN</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>It is the concept Canteen Management in which we can manage the order of the customers.</p>
                        <ul class="py-1">
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>123456798</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>contact@gmail.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>DEHRADUN</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Footer -->
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="contact">
                        <ul>
                            <h1 class="sm">Contact Information</h1>
                            <li> <i class="fas fa-phone-alt"></i> <p>123465798</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>contact@gmail.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>DEHRADUN</p></li>
                        </ul>
                    </article>
